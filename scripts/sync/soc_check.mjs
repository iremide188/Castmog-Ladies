...
const EXPR = `(async () => {
  const btns = [...document.querySelectorAll(".footer-social a")];
  return JSON.stringify({
    jsVer: (document.querySelector('script[src*="coach.js"]')||{}).getAttribute ? document.querySelector('script[src*="coach.js"]').getAttribute("src") : "?",
    count: btns.length,
