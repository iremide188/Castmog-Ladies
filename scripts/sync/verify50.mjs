...
const EXPR = `(async () => {
  ...
  return JSON.stringify({w: Math.round(r.width), h: Math.round(r.height), ar: cs.aspectRatio, ver: ((document.querySelector('link[href*="styles.css"]')||{getAttribute:()=>""}).getAttribute("href")||"").split("?")[1]});
})()`;
