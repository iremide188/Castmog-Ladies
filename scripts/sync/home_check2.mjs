...
const EXPR = `(async () => {
  try {
    return JSON.stringify({
      hasClub: !!window.CLUB,
      staffCards: document.querySelectorAll(".staff-card").length,
      socRows: document.querySelectorAll(".sc-soc-row").length,
      heroOk: !!document.querySelector(".page-hero, .hero, h1")
    });
